    ...
    <body>
        ...
        <div class="taskbar">
            ...
            <div class="right-taskbar" >
                ...
                <div class="dropdown">
                    <form action="adminmanagecategory" method="post" name="sortCata">
            ...
            <tbody>
                ...
                <c:forEach items="${requestScope.listCategory}" var="i">
                    <tr>
                        ...
                        <td>${productDb.totalProductOfCategory(i.category_id)}</td>
        ...
        <div class="add">
            ...
            <form action="addcate?action=add" method="POST">
                <label for="category_name">Category Name:</label><br>
                <input type="text" id="category_name" name="cataName" required><br><br>
                <div class="btn-block">
                    <button type="submit" >Add Catagories</button>
                </div>
            </form>
        </div>
