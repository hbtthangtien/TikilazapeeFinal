                        ...
                        <c:forEach items="${cart.listItem}" var="item">
                            <div class="product-box row" >
                                        ...
                                        <div class="color-box">
                                            ...
                                            <c:forEach items="${item.product.listColor}" var="color">
                                                ...
                                                <label for="${color.color_id};color${item.cartItem_id}"
                                                       onclick="getQuantity(${item.product_id}, ${item.color_id},${item.type_id},${item.cartItem_id})"
                                        ...
                                        <div class="type-box">
                                            ...
                                            <c:forEach items="${item.product.listType}" var="type">
                                                ...
                                                <label for="${type.type_id};type${item.cartItem_id}"
                                                       onclick="getQuantity(${item.product_id},${item.cartItem_id})"
                                ...
                                <div class="col-md-2 product-quantity">
                                    <button class="btn-quantity" onclick="changeQuantity(this, -1,${item.unitPrice},${item.product_id},${item.cartItem_id})"><i class="fa-solid fa-minus"></i></button>
                                    ...
                                    <button class="btn-quantity" onclick="changeQuantity(this, 1,${item.unitPrice},${item.product_id},${item.cartItem_id})"><i class="fa-solid fa-plus"></i></button>
                                </div>
                                <div class="col-md-2 product-total-price">${Feature.format(item.intoPrice)} đ</div>
