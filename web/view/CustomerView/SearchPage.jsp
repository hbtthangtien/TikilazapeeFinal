                        ...
                        <ul class="nav prod-cat">
                            <li>
                                <c:forEach items="${listf}" var="o">
                                    <form action="searchpage" method="get" name="searchProduct">
                                        <li>
                                            <div class="checkbox-container">
                                                <input type="checkbox" name="filter" value="${o.filter_id}" onclick="handleCheckboxChange(this)" />
                                                ${o.nameFilter}
                                            </div>
                                        </li>
                                    </form>
                    ...
                    <div class="panel-body">
                        <div class="col-md-6">
                            <div class="pull-right">
                                <div class="dropdown">
                                    <laber style="margin-right: 10px">Sort</laber>


                                    <form action="searchpage" method="post" name="sortProductSearch" >
