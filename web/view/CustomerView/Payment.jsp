<%-- 
    Document   : Payment
    Created on : Jul 12, 2024, 4:21:20 PM
    Author     : hbtth
--%>
...
<html>
        ...
        <div class="container payment-box-main" style="height: 100vh; width: 100vw; margin-top: 80px;">
            ...
            <div class="delivery-address-box">
                ...
                <div class="information-user">
                    <h3>${s_u_tikilazapee.fullname} (84+)${s_u_tikilazapee.phoneNumber}</h3> <h5>${s_u_tikilazapee.address} &nbsp; &nbsp; &nbsp; &nbsp;<span><a href="#">Change</a></span>
                        <c:if test="${s_u_tikilazapee.address == null || s_u_tikilazapee.phoneNumber == null}"><span>alo</span></c:if>
                        </h5>
                </div>
            </div>
    ...
    <script>
        ...
        btn_placeOrder.addEventListener("click",()=>{
