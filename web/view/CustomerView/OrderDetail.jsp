                ...
                <div class="order-address">
                    ...
                    <div class="order-information-store">                    
                        <div class="information-store">
                            ...
                            <a href="viewstore?store_id=${order.store.user_id}"><i class="fa-solid fa-store"></i> &nbsp;View shop</a>
                        </div>
                        ...
                        <div class="row product-box">
                            ...
                            <div class="col-md-1 product-status" style="font-size: 14px">
                                <c:choose>
                                    ...
                                    <c:when test="${order.order_status == 1}"><p style="color: #6126b7">On shipping to you</p></c:when>
                                    <c:when test="${order.order_status == 2}"><p>Successfully</p></c:when>
                                </c:choose>
                            </div>
                        </div>
