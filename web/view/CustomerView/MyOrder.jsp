                    ...
                    <div class="col-md-11 order" >
                        <div class="top-order">
                            <div class="information-store">
                                ...
                                <a href="viewstore?store_id=${i.store.user_id}"><i class="fa-solid fa-store"></i> &nbsp;View shop</a>
                            </div>
                            <div class="status-order">
                                <c:choose>
                                    <c:when test="${i.order_status == -1}"><p style="color: red">Declined</p></c:when>
                                    <c:when test="${i.order_status == 0}"><p style="color: #919115">Awaiting for confirm</p></c:when>
                                    <c:when test="${i.order_status == 1}"><p style="color: #6126b7">On shipping to you</p></c:when>
                                    <c:when test="${i.order_status == 2}"><p>Successfully</p></c:when>
                                </c:choose>
