...
<html>
                ...
                <div class="col-lg-3 col-md-6 pb-3">
                    <div class="icon-box d-flex">
                        ...
                        <div class="icon-box-content">
                            ...
                            <p>Free shipping, fastest delivery.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 pb-3">
                    <div class="icon-box d-flex">
                        ...
                        <div class="icon-box-content">
                            ...
                            <p>Quality is carefully screened, selecting the best products.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 pb-3">
                    <div class="icon-box d-flex">
                        ...
                        <div class="icon-box-content">
                            ...
                            <p>Offers are exclusive to users, choose us with confidence.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 pb-3">
                    <div class="icon-box d-flex">
                        ...
                        <div class="icon-box-content">
                            ...
                            <p>Safe, secure, transparent in every payment step.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="display-header d-flex justify-content-between pb-3">
            <h2 class="display-7 text-dark text-uppercase">Categories</h2>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="display-header d-flex justify-content-between pb-3">
                    ...
                    <div class="btn-right">
                        <a href="allproduct" class="btn btn-medium btn-normal text-uppercase" style="display: inline-flex;">All Product <span class="material-symbols-outlined">arrow_forward_ios</span></a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="display-header d-flex justify-content-between pb-3">
                    ...
                    <div class="btn-right">
                        <a href="topsaleproduct" class="btn btn-medium btn-normal text-uppercase" style="display: inline-flex;">Sales Product <span class="material-symbols-outlined">arrow_forward_ios</span></a>
                    </div>
                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="row" style="
                                    ...
                                    <div class="card">
                                        <div class="d-flex justify-content-between p-3">
                                            <a href="AddWishList?pid=${i.product_id}" >
                                                <p class="lead mb-0">Add Wish List <i class="fa-regular fa-heart"></i></p>
        ...
        <div class="row d-flex flex-wrap align-items-center">
            <div class="col-md-6 col-sm-12">
                <div class="text-content offset-4 padding-medium">
                    ...
                    <a href="topsaleproduct" class="btn btn-medium btn-dark text-uppercase btn-rounded-none">Shop Sale</a>
                </div>
            </div>
            <div class="col-md-6 col-sm-12">
    ...
    <section id="latest-blog" class="padding-large">
        <div class="container">
            <div class="row">
                <div class="display-header d-flex justify-content-between pb-3">
                    <h2 class="display-7 text-dark text-uppercase">Latest Blog</h2>
                    <div class="btn-right">
                        <a href="http://localhost:9999/tikilazapee/listblog" class="btn btn-medium btn-normal text-uppercase">Read Blog</a>
                    </div>
                </div>
                <div class="post-grid d-flex flex-wrap justify-content-between">
                    ...
                    <div class="col-lg-4 col-sm-12">
                        <div class="card border-none me-3">
                            <a href="blogdetail?blog_id=${b.blog_id}">
                            <div class="card-image">
                                <img src="${b.blog_image}" alt="" class="img-fluid" style="
    width: 413px;
    height: 300px;
">
                            </div>
                        ...
                        <div class="card-body text-uppercase">
                            <div class="card-meta text-muted">
                                <span class="meta-date">${b.blog_create_day}</span>
                                <span class="meta-category">- ${db.getCategoryById(b.getCategory_id()).getCategory_name()}</span>
                            </div>
                            <h3 class="card-title">
                                <a href="blogdetail?blog_id=${b.blog_id}">${b.blog_title}.</a>
                            </h3>
                        </div>
                    </div>
                                         </c:forEach>
                            ...
                            <c:forEach items="${listFeedback}" var="f">
                                <div class="swiper-slide text-center d-flex justify-content-center">
                                    <div class="review-item col-md-10" >
                                        <a href="product?product_id=${f.product_id}">
                                        ...
                                        <div class="author-detail">
                                            ...
                                            <div class="name text-dark text-uppercase pt-2">${pd.getProductByIdProduct(f.product_id).getProduct_name()}</div>
                                            </a>
                                    </div>
                                </div>
                            </c:forEach>
...
<footer id="footer" class="overflow-hidden" style="
    ...
    <script>
        ...
        var url = "AddWishList?pid=" + encodeURIComponent(productId);
