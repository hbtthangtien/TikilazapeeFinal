...
<<<<<<< HEAD
                                            <a href="" onclick="addtocart(${i.product_id}, 1, 1, 1)">
                                                <p class="lead mb-0">Add to Cart<span class="fas fa-cart-plus me-2"></span></p>
=======
                                            <a href="" onclick="addtocart(${i.product_id},1,1,1)">
...
<footer id="footer" class="overflow-hidden" style="
    ...
    <script>
                                                function addtocart(product_id, quantity, type_id) {
                                                    $.ajax({
