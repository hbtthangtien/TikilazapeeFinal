 ...
 * @author Thinh
 */
@WebServlet(name = "BlogManage", urlPatterns = {"/admin/BlogManage"})
public class BlogManage extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("lists", blogDAO.getListBlog());
        ServletContext context = request.getServletContext();
        context.getRequestDispatcher("/view/AdminView/blogsManage.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        BlogDAO blogDAO = new BlogDAO();
        if (valueOption == 0) {
            list = blogDAO.getListBlog();
        } else {
            list = blogDAO.getListBlogSortByTitle();
        }
