...
public class PaymentController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<ItemCart> list = db.getItems(item_id);
        int totalMoney = db.getTotalPrice(item_id);
        request.setAttribute("items", list);
        request.setAttribute("total", totalMoney);
        request.getRequestDispatcher("view/CustomerView/Payment.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        long amount = json.getInt("amount")*100L;
        String bankCode = "";//request.getParameter("bankCode");        
        String vnp_TxnRef = VNPAY_config.getRandomNumber(8);
        String vnp_IpAddr = VNPAY_config.getIpAddress(request);
        ...
        vnp_Params.put("vnp_OrderType", VNPAY_config.orderType);
        ...
        Gson gson = new Gson();
        response.getWriter().print(gson.toJson(job));
    }
